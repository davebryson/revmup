...
impl Context {
    ...
    pub fn expand(&self) -> Result<ExpandedContract> {
        ...
        // @note changed!
        //let ethers_contract = "revmup_contract::contract";
        //let ethers_providers = "revmup_client::RevmClient";
        ...
        let contract = quote! {
                ...
                impl<M: ::revmup_client::RevmClient> #name<M> {
                    ...
                    pub fn new<T: Into<#ethers_core::types::Address>>(address: T, client: ::std::sync::Arc<M>) -> Self {
                        Self(::revmup_contract::contract::Contract::new(address.into(), #abi_name.clone(), client))
                    }
                ...
                impl<M: ::revmup_client::RevmClient> From<::revmup_contract::contract::Contract<M>> for #name<M> {
    ...
    pub fn from_abigen(args: Abigen) -> Result<Self> {
        ...
        let abi_str = args
            .abi_source
            .get()
            .map_err(|e| eyre!("failed to get ABI JSON: {e}"))?;
    ...
    pub(crate) fn struct_declaration(&self) -> TokenStream {
        ...
        quote! {
            ...
            // @note: changed
            // Struct declaration
            pub struct #name<M>(::revmup_contract::contract::Contract<M>);
...
where
    ...
    F: Fn(&str) -> Ident,
{
    let not_aliased = elements
        .into_iter()
        .filter(|(sig, _name)| !aliases.contains_key(sig))
        .collect::<Vec<_>>();
