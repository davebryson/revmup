...
pub mod counter {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                (
                    ::std::borrow::ToOwned::to_owned("addAndSet"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("addAndSet"),
                            inputs: ::std::vec![
    ...
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[Pa\x01|\x80a\0 `\09`\0\xF3\xFE`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[P`\x046\x10a\0LW`\x005`\xE0\x1C\x80c?\xB5\xC1\xCB\x14a\0QW\x80c|\xDC\xAA\x84\x14a\0fW\x80c\x83\x81\xF5\x8A\x14a\0yW\x80c\xD0\x9D\xE0\x8A\x14a\0\x94W[`\0\x80\xFD[a\0da\0_6`\x04a\0\xC3V[`\0UV[\0[a\0da\0t6`\x04a\0\xDCV[a\0\x9CV[a\0\x82`\0T\x81V[`@Q\x90\x81R` \x01`@Q\x80\x91\x03\x90\xF3[a\0da\0\xADV[a\0\xA6\x81\x83a\x01\x14V[`\0UPPV[`\0\x80T\x90\x80a\0\xBC\x83a\x01-V[\x91\x90PUPV[`\0` \x82\x84\x03\x12\x15a\0\xD5W`\0\x80\xFD[P5\x91\x90PV[`\0\x80`@\x83\x85\x03\x12\x15a\0\xEFW`\0\x80\xFD[PP\x805\x92` \x90\x91\x015\x91PV[cNH{q`\xE0\x1B`\0R`\x11`\x04R`$`\0\xFD[\x80\x82\x01\x80\x82\x11\x15a\x01'Wa\x01'a\0\xFEV[\x92\x91PPV[`\0`\x01\x82\x01a\x01?Wa\x01?a\0\xFEV[P`\x01\x01\x90V\xFE\xA2dipfsX\"\x12 T\x02\xEDp\xF9G\xCD\x13\xCD|\x15^\xF8\xBEP\x04\xAC\x17\xD9|P\xDE\xCF\xBA\xC2T\xE3\xB1\xE1`\xAD\x84dsolcC\0\x08\x14\x003";
    /// The bytecode of the contract.
    pub static COUNTER_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    const __DEPLOYED_BYTECODE: &[u8] = b"`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[P`\x046\x10a\0LW`\x005`\xE0\x1C\x80c?\xB5\xC1\xCB\x14a\0QW\x80c|\xDC\xAA\x84\x14a\0fW\x80c\x83\x81\xF5\x8A\x14a\0yW\x80c\xD0\x9D\xE0\x8A\x14a\0\x94W[`\0\x80\xFD[a\0da\0_6`\x04a\0\xC3V[`\0UV[\0[a\0da\0t6`\x04a\0\xDCV[a\0\x9CV[a\0\x82`\0T\x81V[`@Q\x90\x81R` \x01`@Q\x80\x91\x03\x90\xF3[a\0da\0\xADV[a\0\xA6\x81\x83a\x01\x14V[`\0UPPV[`\0\x80T\x90\x80a\0\xBC\x83a\x01-V[\x91\x90PUPV[`\0` \x82\x84\x03\x12\x15a\0\xD5W`\0\x80\xFD[P5\x91\x90PV[`\0\x80`@\x83\x85\x03\x12\x15a\0\xEFW`\0\x80\xFD[PP\x805\x92` \x90\x91\x015\x91PV[cNH{q`\xE0\x1B`\0R`\x11`\x04R`$`\0\xFD[\x80\x82\x01\x80\x82\x11\x15a\x01'Wa\x01'a\0\xFEV[\x92\x91PPV[`\0`\x01\x82\x01a\x01?Wa\x01?a\0\xFEV[P`\x01\x01\x90V\xFE\xA2dipfsX\"\x12 T\x02\xEDp\xF9G\xCD\x13\xCD|\x15^\xF8\xBEP\x04\xAC\x17\xD9|P\xDE\xCF\xBA\xC2T\xE3\xB1\xE1`\xAD\x84dsolcC\0\x08\x14\x003";
    /// The deployed bytecode of the contract.
    pub static COUNTER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct Counter<M>(::revmup_contract::contract::Contract<M>);
    ...
    impl<M: ::revmup_client::RevmClient> Counter<M> {
        ...
        pub fn deploy<T: ::ethers::core::abi::Tokenize>(
            ...
            let abi = ethers::abi::Abi::from(COUNTER_ABI.clone());
            let encoded = match abi.constructor() {
                Some(c) => {
                    c.encode_input(COUNTER_BYTECODE.clone().to_vec().into(), &params)?
                }
                _ => COUNTER_BYTECODE.clone().to_vec().into(),
            };
        ...
        ///Calls the contract's `addAndSet` (0x7cdcaa84) function
        pub fn add_and_set(
            &self,
            ...
            self.0
                .method_hash([124, 220, 170, 132], (x, y))
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `increment` (0xd09de08a) function
        pub fn increment(&self) -> ::revmup_contract::call::ContractCall<M, ()> {
            self.0
        ...
        pub fn number(
            &self,
        ) -> ::revmup_contract::call::ContractCall<M, ::ethers::core::types::U256> {
            self.0
    ...
    ///Container type for all input parameters for the `addAndSet` function with signature `addAndSet(uint256,uint256)` and selector `0x7cdcaa84`
    #[derive(
        Clone,
    ...
    #[ethcall(name = "addAndSet", abi = "addAndSet(uint256,uint256)")]
    pub struct AddAndSetCall {
    ...
    impl ::ethers::core::abi::AbiDecode for CounterCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <AddAndSetCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::AddAndSet(decoded));
            }
            if let Ok(decoded)
    ...
    impl ::core::fmt::Display for CounterCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AddAndSet(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<AddAndSetCall> for CounterCalls {
        fn from(value: AddAndSetCall) -> Self {
            Self::AddAndSet(value)
        }
    }
